function efetuarCadastro() {
  ...
  fetch("http://localhost:5000/api/produto/cadastrar", {
    ...
    body: JSON.stringify({
      // Antes dos dois pontos, faz parte do servidor
      // Depois dos dois pontos, é conteúdo que será inserido e encaminhado para o servidor
      nome: nome.value,
...
// Mostrar os produtos na tela de carregamento
...
// Abrir e fechar o formulário com o mesmo botão
function abrirForm() {
